...
gen_llm = llm_factory.create_chat_llm().with_structured_output(schema=PPT)
...
edit_agent = edit_prompt | llm_factory.create_chat_llm().with_structured_output(schema=EditResp)
